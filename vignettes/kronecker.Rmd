...
site 1 (0.14), so their block — outlined in deep green below — is the same temporal
pattern, just faint:

```{r kron-product, echo = FALSE, fig.height = 4.8, fig.alt = "The full 24-by-24 space-time covariance as a heatmap of 9 blocks in a 3-by-3 grid; each block repeats the temporal kernel scaled by one spatial correlation, and the faint block linking site 1 and site 3 is outlined in deep green"}
