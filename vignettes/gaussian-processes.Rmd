...
package's `quick_mvnorm()` samples such a function efficiently; here a small
helper wraps it to produce several draws.
...
```{r prior-draws-rbf, fig.height = 5.2}
prior_draws <- rbind(
...
```{r prior-draws-periodic, fig.height = 3.8}
