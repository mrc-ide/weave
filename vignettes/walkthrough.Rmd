...
posterior **variance** is estimated from `n_draws` perturbation draws. The
latent-rate posterior is then combined with Negative-Binomial observation
...
that quietly mean-imputes the gaps. A future count is uncertain for two
