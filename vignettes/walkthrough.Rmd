...
dispersion of part 3 are two views of the same count scatter — see
[*The nugget and the dispersion*](noise.html).)
:::
...
observed counts. (If it seems the observation noise has now been modelled
twice — once as the nugget, once as \( r \) — it has not: the two feed
different terms of the variance above. The short companion note
[*The nugget and the dispersion*](noise.html) explains how they relate.)
:::
