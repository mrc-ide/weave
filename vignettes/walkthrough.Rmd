...
- **Hyperparameter fitting mean-imputes missing cells** in the plug-in field
  (though `gp_predict()` does not — it conditions on the observed cells, so its
  interval widens over gaps).
