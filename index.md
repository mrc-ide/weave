...
you are starting from one raw data frame,
[`data_process()`](https://mrc-ide.github.io/weave/reference/data_process.md)
returns `obs_data`, `coordinates` and `nt` in exactly this shape. The
workflow is then two calls — estimate the kernels, then predict:
...
- [Using weave with your own
  ...
  — preparing raw data with
  [`data_process()`](https://mrc-ide.github.io/weave/reference/data_process.md),
  encoding time correctly, and predicting beyond the observed weeks.
- [The Kronecker
